...
/* -------------------------------------------------------------------------
 * AudioContext-Attrappe
 *
 * Node kennt keine Web Audio API. Der Spielcode baut den Graphen erst in
 * AudioEngine.init(), und die scheitert hier ohnehin am fehlenden Mikrofon —
 * die Attrappe muss deshalb nur so viel koennen, dass ein versehentlicher
 * Aufruf nicht wirft.
 *
 * (Bis ARENA-25 stand hier zusaetzlich eine <audio>-Attrappe fuer den
 * Klavier-Modus. Der ist mit ARENA-26 entfallen.)
 * ---------------------------------------------------------------------- */
...
class FakeAudioContext {
    ...
    createAnalyser() {
        return { fftSize: 2048, connect: noop, disconnect: noop,
